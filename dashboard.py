...
class Dashboard(QMainWindow):
	...
	def _create_line_list(self):
		...
		# 예제 데이터 추가
		example_data = [
			["●", "1", "회선-001", "192.168.0.101", "홍길동", "USER001", "정상 연결됨", "", ""],
			["●", "2", "회선-002", "192.168.0.102", "김철수", "USER002", "정상 연결됨", "", ""],
			["○", "3", "회선-003", "192.168.0.103", "이영희", "USER003", "연결 김", "확인 필요", ""],
			["●", "4", "회선-004", "192.168.0.104", "박민수", "USER004", "정상 연결됨", "", ""],
			["●", "5", "회선-005", "192.168.0.105", "최영식", "USER005", "정상 연결됨", "", ""],
			["○", "6", "회선-006", "192.168.0.106", "정미영", "USER006", "연결 끊김", "점검 중", ""],
			["●", "7", "회선-007", "192.168.0.107", "강동원", "USER007", "정상 연결됨", "", ""],
			["●", "8", "회선-008", "192.168.0.108", "윤서연", "USER008", "정상 연결됨", "", ""],
			["●", "9", "회선-001", "192.168.0.101", "홍길동", "USER001", "정상 연결됨", "", ""],
			["●", "10", "회선-002", "192.168.0.102", "김철수", "USER002", "정상 연결됨", "", ""],
			["○", "11", "회선-003", "192.168.0.103", "이영희", "USER003", "연결 끊김", "확인 필요", ""],
			["●", "12", "회선-004", "192.168.0.104", "박민수", "USER004", "정상 연결됨", "", ""],
			["●", "13", "회선-005", "192.168.0.105", "최영식", "USER005", "정상 연결됨", "", ""],
			["○", "14", "회선-006", "192.168.0.106", "정미영", "USER006", "연결 끊김", "점검 중", ""],
			["●", "15", "회선-007", "192.168.0.107", "강동원", "USER007", "정상 연결됨", "", ""],
			["●", "16", "회선-008", "192.168.0.108", "윤서연", "USER008", "정상 연결됨", "", ""],            
		]
